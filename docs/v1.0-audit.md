...
之前的占比(26 完全 / 9 部分 / 50+ 未实现 ~43%)是基于 80 项估算。现在实际 web 共 ~220 项功能,**功能覆盖率重算 ~16% 完全 / 部分**。差距比想象的大,但同样:**已 ship 的 26 项都是核心战斗循环**(移动 / 攻击 / 治疗 / 占领 / 招募 / 待命 / 回合 / CO / HUD / 浮动文本 / FLIP / 大厅基础) — v0.3 demo "完整 1 局 vs AI" 跑得通的真本事。
