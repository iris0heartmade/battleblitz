...
| 文件 | 项 | 状态 |
|------|-----|------|
| `game/app/config.py` | `SKILL_HEAL`, `SKILL_RALLY`, `DEFAULT_MELEE_RANGE`, `AI_SKILL_HEAL_THRESHOLD_HP`, `TOTAL_TILES` | ✅ 已删除 |
| `game/app/events/bus.py` | `subscriber_count()`, `total_subscribers()` | ✅ 已删除 |
| `game/app/agent/llm_client.py` | `health_check()`, `aclose()` | ✅ 已删除 |
| `game/app/agent/openai_client.py` | `health_check()`, `aclose()` | ✅ 已删除 |
...
## 3. 修正 [`路线.md`](../路线/路线.md) / [`架构.md`](../架构/架构.md) 中的错误数据
...
**建议修订文档措辞**：
> "🚧 死代码清理（[`死代码.md`](死代码清单.md) 列了 5 个 dead config + 11 个 dead import + 6 个 dead method）"
...
*最后更新：2026-06-28*
*配套：[`架构.md`](../架构/架构.md) §0.2、[`路线.md`](../路线/路线.md) §0.2、[`阶段.md`](../架构/阶段.md) P0 阶段*