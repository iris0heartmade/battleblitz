...
- Map editor first slice: menu entry, dedicated editor view, board-backed 15x15 preview, terrain/biome controls, click-to-paint terrain, saved-map listing/loading, and `/editor/maps` network wrappers.
...
1. **Map editor is only partially ported.**
   Godot now has an editor entry, panel, board-backed preview, terrain/biome controls, click-to-paint terrain, saved-map listing/loading, and editor API wrappers. It still needs delete, unit placement, resize, undo/redo, and richer WebUI-style editing workflows.
...
1. Finish the Godot map editor first slice: delete custom maps and confirm saved `custom:{id}` maps appear in lobby presets.
