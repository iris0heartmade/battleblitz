...
1. **Map editor is not ported.**
   The Web UI has a full editor view with terrain tools, unit placement, resize, biome selection, undo/redo, load, and save. Godot currently has no equivalent editor screen. This is the largest remaining WebUI-only feature.
